...
<div id="about" class="container-fluid">
  <div class="row">
    ...
    <br><br>
      <h2>Main Admin View</h2><br>
     
     <h3><a href="Isopod-Ecommerce/manager/hrmanagement.php"> Employee Hr Managment </a></h3>
     <h3> <a href="Isopod-Ecommerce/manager/showinventory.php">Inventory</a></h3>
     <h3> <a href="Isopod-Ecommerce/manager/newproduct.php" >Add product</a></h3>
    </div>
