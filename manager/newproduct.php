  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
           <li><a href="public_html/index.php">All Items</a></li>
       ...
       <button type="button" class="btn btn-default btn-sm">
        ...
        <p>  <?php echo $_SESSION["EmployeeUsername"]; ?> </p>
...
<div id="about" class="container-fluid">
  ...
  <h1>Isopod Galore - New Product Entry</h1>

  <form action="Isopod-Ecommerce/manager/insertproduct.php" method="post">
    <table border="0">
    
      <tr>
        <td>Product Name</td>
         <td><input type="text" name="productname" maxlength="13" size="13"></td>
      </tr>
      <tr>
        <td>Product ID</td>
        <td> <input type="text" name="productid" maxlength="30" size="30"></td>
      </tr>
      <tr>
        <td>Picture</td>
        <td> <input type="text" name="picture" maxlength="60" size="30"></td>
      </tr>
      <tr>
        <td>Price $</td>
       ...
       <tr>
        <td>Quantity</td>
        <td> <input type="text" name="quantity" maxlength="30" size="30"></td>
      </tr>
      <tr>
    ...
    echo 'You are either <a href="../../index.php">logged out</a> or not an admin.<br />';
}
?> 
